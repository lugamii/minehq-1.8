...
import dev.lugami.potpvp.arena.event.ArenaAllocatedEvent;
import dev.lugami.potpvp.arena.event.ArenaReleasedEvent;
import dev.lugami.potpvp.arena.listener.ArenaItemResetListener;
...
public final class ArenaHandler {
     ...
     * which arenas are eligible for use. Handles calling {@link dev.lugami.potpvp.arena.event.ArenaAllocatedEvent}
     * automatically.
     ...
     * {@link dev.lugami.potpvp.arena.event.ArenaReleasedEvent} automatically.
