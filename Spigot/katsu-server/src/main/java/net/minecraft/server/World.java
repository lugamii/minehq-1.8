...
import dev.lugami.spigot.util.OptimizedRemoveUtil;
...
public abstract class World implements IBlockAccess {
    ...
    public void entityJoinedWorld(Entity entity, boolean flag) {
        ...
        // Spigot start
        if (KatsuSpigot.INSTANCE.getConfig().isEntityActivation() && !org.spigotmc.ActivationRange.checkIfActive(entity)) {
            entity.ticksLived++;
            entity.inactiveTick();
