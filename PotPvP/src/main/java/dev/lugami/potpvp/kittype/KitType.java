package dev.lugami.potpvp.kittype;
...
public final class KitType {
    ...
    static {
        ...
        /**
         * //This is how you make kits
         *         if (byId("NODEBUFF")  == null) { // has too be all upper case
         *             KitType kitType = new KitType();
         *             kitType.id = "NODEBUFF";
         *             kitType.setDisplayColor(ChatColor.GOLD);
         *             kitType.setDisplayName("No Debuff"); // the name used in game for queues and stuff
         *             kitType.setIcon(new MaterialData(Material.DIAMOND_SWORD)); // item shown in queue
         *
         *             allTypes.add(kitType);
         *         }
         *         //another example :) yo do u have like good kb set? kb u set in game with c
         *         if (byId("SUMO")  == null) { // has too be all upper case
         *             KitType kitType = new KitType();
         *             kitType.id = "SUMO";
         *             kitType.setDisplayColor(ChatColor.GOLD);
         *             kitType.setDisplayName("Sumo"); // the name used in game for queues and stuff
         *             kitType.setIcon(new MaterialData(Material.DIAMOND_SWORD)); // item shown in queue
         *
         *             allTypes.add(kitType);
         *         }
