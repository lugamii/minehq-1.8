...
public class CommandNode {
    ...
    public boolean invoke(CommandSender sender, Arguments arguments) throws CommandException {
        ...
        try {
            ...
            if (!this.async && this.logToConsole && stopwatch.getTime() >= executionThreshold) {
                qLib.getInstance().getLogger().warning("Command '/" + this.getFullLabel() + "' took " + stopwatch.getTime() + "ms!");
            }
            return true;
        }
