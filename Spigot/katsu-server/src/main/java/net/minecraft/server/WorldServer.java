...
public class WorldServer extends World implements IAsyncTaskHandler {
    ...
    public void doTick(int ticks) {
        ...
        if (KatsuSpigot.INSTANCE.getConfig().isDoChunkUnload()) {
    ...
    protected void h() {
        ...
        if (this.worldData.getType() == WorldType.DEBUG_ALL_BLOCK_STATES) {
            ...
            for (gnu.trove.iterator.TLongShortIterator iter = chunkTickList.iterator(); iter.hasNext(); ) {
                ...
                if (KatsuSpigot.INSTANCE.getConfig().isBlockOperations()) {
            ...
            if (this.generator != null) {
                ...
                if (spawn != null) {
                    if (spawn.getWorld() != ((WorldServer) this).getWorld()) {
                        ...
                        this.worldData.setSpawn(new Location(getWorld(),spawn.getBlockX(), spawn.getBlockY(), spawn.getBlockZ()));
