package dev.lugami.qlib.configuration;

import dev.lugami.qlib.configuration.annotations.ConfigData;
import dev.lugami.qlib.configuration.annotations.ConfigSerializer;
