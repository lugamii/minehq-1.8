package dev.lugami.bridge.bukkit.util;
...
public class Reflection {
    ...
    public static Class<?> getNmsClass(String name) {
        String className = "net.minecraft.server.v1_8_R3." + getVersion() + "." + name;
        return getClass(className);
    }

    public static Class<?> getCbClass(String name) {
        String className = "org.bukkit.craftbukkit.v1_8_R3." + getVersion() + "." + name;
        return getClass(className);
    }
    ...
    public static Class<?> getUtilClass(String name) {
        try {
            ...
            try {
                return Class.forName("" + name); //Not 1.8
