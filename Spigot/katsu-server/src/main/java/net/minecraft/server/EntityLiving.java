...
import dev.lugami.spigot.event.potion.PotionEffectAddEvent;
import dev.lugami.spigot.event.potion.PotionEffectExpireEvent;
import dev.lugami.spigot.event.potion.PotionEffectExtendEvent;
import dev.lugami.spigot.event.potion.PotionEffectRemoveEvent;
import dev.lugami.spigot.knockback.KnockbackProfile;
import dev.lugami.spigot.util.CraftPotionUtil;
...
public abstract class EntityLiving extends Entity {
    ...
    public void a(Entity entity, float f, double d0, double d1) {
        if (this.random.nextDouble() >= this.getAttributeInstance(GenericAttributes.c).getValue()) {
            ...
            KnockbackProfile profile = this.getKnockbackProfile() == null ? KatsuSpigot.INSTANCE.getConfig().getCurrentKb() : this.getKnockbackProfile();
