...
@Getter
@Setter
public class KatsuConfig {

    private static final String HEADER = "This is the main configuration file for KatsuSpigot.\n"
    ...
    public KatsuConfig() {
        ...
        try {
            ...
            KatsuBridge.version = (String) prop.getOrDefault("version", "Unknown");
        }
        ...
        this.config.options().header(KatsuConfig.HEADER);
    ...
    private void loadConfig() {
        ...
        KatsuBridge.disableOpPermissions = this.getBoolean("disable-op", true);
