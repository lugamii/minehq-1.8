package dev.lugami.bridge.bukkit.listener;

import dev.lugami.bridge.BridgeGlobal;
import dev.lugami.bridge.bukkit.Bridge;
import dev.lugami.bridge.bukkit.parameters.packets.filter.FilterViolationPacket;
import dev.lugami.bridge.bukkit.util.Chat;
import dev.lugami.bridge.global.handlers.MongoHandler;
...
import dev.lugami.bridge.global.updater.UpdateStatus;
import dev.lugami.bridge.global.util.EncryptionHandler;
import dev.lugami.bridge.global.util.Msg;
import dev.lugami.bridge.global.util.Tasks;
import dev.lugami.bridge.bukkit.BukkitAPI;
import dev.lugami.bridge.bukkit.commands.punishment.create.MuteCommand;
import dev.lugami.qlib.chat.ChatHandler;
import dev.lugami.qlib.chat.ChatPlayer;
import dev.lugami.qlib.chat.ChatPopulator;
    ...
    public void onJoin(PlayerJoinEvent e) {
        ...
        Bukkit.getScheduler().runTaskAsynchronously(Bridge.getInstance(), () -> {
            ...
            if (profile != null) {
                ...
                if (qLib.getInstance().getTabHandler().getTabList() != null) {
