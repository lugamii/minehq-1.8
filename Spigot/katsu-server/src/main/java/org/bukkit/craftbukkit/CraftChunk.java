...
public class CraftChunk implements Chunk {
	...
	@Override
	public dev.lugami.spigot.chunk.ChunkSnapshot takeSnapshot() {
		net.minecraft.server.Chunk handle = getHandle();
		dev.lugami.spigot.chunk.CraftChunkSnapshot snap = new dev.lugami.spigot.chunk.CraftChunkSnapshot();
	...
	@Override
	public void restoreSnapshot(dev.lugami.spigot.chunk.ChunkSnapshot snapshot) {
		dev.lugami.spigot.chunk.CraftChunkSnapshot snap = (dev.lugami.spigot.chunk.CraftChunkSnapshot) snapshot;
		net.minecraft.server.Chunk handle = getHandle();
