...
public class QueueUnPausePacket implements Packet {

    private String queueName;
    private boolean pause;
    private String sender;

    public QueueUnPausePacket(Queue queue, boolean pause, String sender) {
    ...
    public QueueUnPausePacket(String queueName, boolean pause, String sender) {
